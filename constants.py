...
from langchain.document_loaders import CSVLoader, TextLoader, UnstructuredExcelLoader, Docx2txtLoader, PDFMinerLoader
...
MODEL_BASENAME = "mistral-7b-instruct-v0.1.Q6_K.gguf"
